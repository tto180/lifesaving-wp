...
define( 'WC_GATEWAY_PURCHASE_ORDER_VERSION', '1.5.1' ); // WRCS: DEFINED_VERSION.
 ...
 * @return void
 */
function woocommerce_gateway_purchase_order_load_textdomain(): void {
...
add_action( 'plugins_loaded', 'woocommerce_gateway_purchase_order_load_textdomain' );

					...
					if ( $group && is_object( $group ) ) {
						...
						>
							...
							<td class="uo-ld-group-drip-topic-row__actions">
								<button type="button"
										class="uo-ld-group-drip-topic__action uo-ld-group-drip-topic__action--save ultp-gutenberg-btn">
									<?php esc_attr_e( 'Save date', 'uncanny-pro-toolkit' ); ?>
								</button>

								<button type="button"
										class="uo-ld-group-drip-topic__action uo-ld-group-drip-topic__action--remove ultp-gutenberg-btn">

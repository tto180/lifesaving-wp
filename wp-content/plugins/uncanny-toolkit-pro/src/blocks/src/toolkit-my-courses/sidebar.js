                ...
                <Fragment>
                    ...
                    <InspectorControls>
                        ...
                        <PanelBody title={ __( 'Dashboard Behavior', 'uncanny-pro-toolkit' ) }>
                            ...
                            <TextControl
                                label={ __( 'No courses message', 'uncanny-pro-toolkit' ) }
                                value={ props.attributes.no_courses_message }
                                type='text'
                                help={ __( '', 'uncanny-pro-toolkit' ) }
                                onChange={ ( value ) => {
                                    props.setAttributes({ no_courses_message: value });
                                }}
                            />

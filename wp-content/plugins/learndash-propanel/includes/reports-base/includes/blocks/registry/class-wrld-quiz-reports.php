...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Quiz_Reports' ) ) {
	/**
	 * This class contains the Functionality required to register the Quiz Reports Block
	 */
	class WRLD_Quiz_Reports extends WRLD_Register_Block {
		 ...
		 */
		public function __construct( $block_name = 'quiz-reports', $block_title = 'Quiz Reports', $description = 'This block will be visible when quiz filters are in use & will be used to display the results for the quiz filters', $server_side_callback = false, $api_version = 2 ) {

...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Total_Courses' ) ) {
	/**
	 * This class contains the Functionality required to register the Total Courses Block
	 */
	class WRLD_Total_Courses extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'total-courses', $block_title = 'Total Courses', $description = 'Displays the count of courses', $server_side_callback = 'server_side_render_function', $api_version = 2 ) {

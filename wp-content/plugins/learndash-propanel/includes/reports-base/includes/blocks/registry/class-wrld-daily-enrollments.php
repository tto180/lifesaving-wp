...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Daily_Enrollments' ) ) {
	/**
	 * This class contains the Functionality required to register the Daily Enrollments Block
	 */
	class WRLD_Daily_Enrollments extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'daily-enrollments', $block_title = 'Daily Student Enrollments', $description = 'Graph of daily enrollments vs the enrollments in the previous period.', $server_side_callback = false, $api_version = 2 ) {

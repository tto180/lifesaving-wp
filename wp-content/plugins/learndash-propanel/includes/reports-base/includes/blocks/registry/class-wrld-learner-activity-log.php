...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Learner_Activity_Log' ) ) {
	/**
	 * This class contains the Functionality required to register the Learner Activity Log Block
	 */
	class WRLD_Learner_Activity_Log extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'learner-activity-log', $block_title = 'Learner Activity Log', $description = 'Learner Activity Log', $server_side_callback = false, $api_version = 2 ) {

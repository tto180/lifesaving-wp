...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Course_Completion_Rate' ) ) {
	/**
	 * This class contains the Functionality required to register the Course Completion Rate Block
	 */
	class WRLD_Course_Completion_Rate extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'course-completion-rate', $block_title = 'Course Completion Rate', $description = 'Course Completion Rate', $server_side_callback = false, $api_version = 2 ) {

...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Revenue_From_Courses' ) ) {
	/**
	 * This class contains the Functionality required to register the Revenue From Courses Block
	 */
	class WRLD_Revenue_From_Courses extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'revenue-from-courses', $block_title = 'Revenue From Courses', $description = 'Displays the total revenue earned during the selected time & its comparison with the previous duration', $server_side_callback = false, $api_version = 2 ) {

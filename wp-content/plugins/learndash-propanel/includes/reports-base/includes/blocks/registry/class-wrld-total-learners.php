...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Total_Learners' ) ) {
	/**
	 * This class contains the Functionality required to register the Total Learners Block
	 */
	class WRLD_Total_Learners extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'total-learners', $block_title = 'Learners Count', $description = 'Displays the count of learners enrolled', $server_side_callback = 'server_side_render_function', $api_version = 2 ) {

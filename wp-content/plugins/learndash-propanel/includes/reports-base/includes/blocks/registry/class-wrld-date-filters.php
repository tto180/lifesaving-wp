...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Date_Filters' ) ) {
	/**
	 * This class contains the Functionality required to register the Date Filters Block
	 */
	class WRLD_Date_Filters extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = '', $block_title = '', $description = '', $server_side_callback = false, $api_version = 2 ) {

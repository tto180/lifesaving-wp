...
if ( ! class_exists( '\WisdmReportsLearndashBlockRegistry\WRLD_Quiz_Completion_Rate_Per_Course' ) ) {
	/**
	 * This class contains the Functionality required to register the Quiz Completion Rate PEr Course Block
	 */
	class WRLD_Quiz_Completion_Rate_Per_Course extends WRLD_Register_Block {
		/**
		 * Constructor.
		 *
		 ...
		 */
		public function __construct( $block_name = 'quiz-completion-rate-per-course', $block_title = 'Quiz Completion Rate Per Course', $description = 'Graph of daily enrollments vs the enrollments in the previous period.', $server_side_callback = false, $api_version = 2 ) {

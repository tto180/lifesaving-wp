	...
	<div class="wrld-la-modal-content">
		...
		<a class="wrld-dismiss-link" href="<?php echo esc_html( $dismiss_link ); ?>"><span class="dashicons dashicons-no-alt wrld-close-modal-btn"></span></a>
			...
			<div class="wrld-la-modal-text">
				<?php echo esc_html__( 'We have Introduced two ', 'learndash-reports-pro' ); ?>
				<b class="add-la-weight"><?php echo esc_html__( 'new Gutenberg blocks: Inactive user list and Learner Activity log', 'learndash-reports-pro' ); ?></b>
				<?php echo esc_html__( 'so that you can understand and take actions to improve learners engagement in the course', 'learndash-reports-pro' ); ?>
			</div>
					...
					<div class="wrld-la-btn-container">
						<div class="left-box">
							...
							<div class="second-row">
								<?php esc_html_e( 'Go to the dashboard page --> edit --> search for the Learner activity blocks --> Insert.', 'learndash-reports-pro' ); ?>
						...
						<div class="right-box">
							<div class="first-r-row">
								...
								<?php esc_html_e( 'While Auto updating  we will delete the current blocks pattern and replace with the new one including the learner activity block', 'learndash-reports-pro' ); ?>
								<b

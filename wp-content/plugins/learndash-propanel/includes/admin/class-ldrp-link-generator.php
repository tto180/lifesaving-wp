		...
		public function qre_localize_data() {
			if ( isset( $_GET['page'] ) && isset( $_GET['module'] ) && 'ldAdvQuiz' === $_GET['page'] && 'statistics' === $_GET['module'] && isset( $_GET['id'] ) && '' !== $_GET['id'] ) {// phpcs:ignore WordPress.Security.NonceVerification
				...
				$qre_localized_data = array(
					...
					'notice_text'                 => __( '<p> Dear User, </p><p> This is to inform you that LearnDash does not collect any user data. The data that is being exported is your sole responsibility and we urge you to update the privacy policy of your website. </p> <p> Regards, </p> <p> LearnDash </p>', 'quiz_reporting_learndash' ),
				);

<?php
/**
 * Template for statistics export modal
 *
...
<div id="my_bulk_export_popup" style="display:none;">
	<div class="bulk-export-modal">
		<div style="width: 100%;">
			...
			<div class="export-note"><span><?php esc_html_e( 'Note: We recommend to download at most 10000 number of quiz attempts to avoid server timeout.', 'learndash-reports-pro' ); ?></span>
			</div>
		</div>
	</div>
</div>

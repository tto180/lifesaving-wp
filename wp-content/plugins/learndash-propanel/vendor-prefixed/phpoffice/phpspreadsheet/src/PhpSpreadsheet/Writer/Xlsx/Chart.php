...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     */

...
class Html extends BaseWriter
{
    ...
    /**
     * Create CSS style (\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Alignment).
     *
    ...
    /**
     * Create CSS style (\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font).
     *
     * @return array
     */
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $worksheet) {
            ...
            if ($orientation === \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {

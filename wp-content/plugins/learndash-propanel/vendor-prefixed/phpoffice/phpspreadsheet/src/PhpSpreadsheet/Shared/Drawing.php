...
class Drawing
{
     ...
     * @param \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size

...
class Worksheet extends BIFFwriter
{
     ...
     *
     * @var \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
    ...
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     *
     * @return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher $pValue
     */
    public function setEscher(?\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher $pValue = null): void
    {
        $this->escher = $pValue;
    }

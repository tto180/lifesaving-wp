...
class Pro_Legacy_Integrations {
	...
	public function __construct() {
		$this->automator_pro_path = $this->get_automator_pro_path();
	 ...
	 * @return string
	 */
	public function get_automator_pro_path() {
		return rtrim( UAPro_ABSPATH, DIRECTORY_SEPARATOR ) . '/';
	}
	...
	public function load_class_map_file() {
		return include UAPro_ABSPATH . 'vendor' . DIRECTORY_SEPARATOR . 'composer' . DIRECTORY_SEPARATOR . 'autoload_classmap.php';
	}
	...
	public function process_path( $path, $class ) {
		...
		$integration_path = $this->automator_pro_path . 'src/integrations/' . $integration_name . '/';
	...
	public function get_relative_path( $path ) {
		return str_replace( $this->get_automator_pro_path(), '', $path );
	}
}

...
/**
 * Class JETCRM_TAG_ADDED_TO_CONTACT
 *
...
class JETCRM_TAG_ADDED_TO_CONTACT {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'JETCRM_TAG_TO_CONTACT' );
		...
		/* Translators: Trigger sentence */
			sprintf( esc_attr__( '{{A tag:%1$s}} is added to a contact', 'uncanny-automator-pro' ), $this->get_trigger_meta() )
		);
		// Non-active state sentence to show
		$this->set_readable_sentence( esc_attr__( '{{A tag}} is added to a contact', 'uncanny-automator-pro' ) );
	...
	protected function validate_trigger( ...$args ) {
		...
		if ( ! isset( $tag_id ) && ZBS_TYPE_CONTACT !== $obj_type ) {
			return false;
		}

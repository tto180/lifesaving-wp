...
class JETCRM_QUOTE_ACCEPTED {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'JETCRM_QUOTE_ACCEPTED' );
		...
		/* Translators: Trigger sentence */
			esc_attr__( 'A quote status is accepted', 'uncanny-automator-pro' )
		);
		// Non-active state sentence to show
		$this->set_readable_sentence( esc_attr__( 'A quote status is accepted', 'uncanny-automator-pro' ) );
		// Which do_action() fires this trigger.
		$this->set_action_hook( 'jpcrm_quote_accepted' );

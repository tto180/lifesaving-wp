...
class Add_Wf_Integration {
	...
	public function add_integration_func() {
		...
		Automator()->register->integration(
			...
			array(
				'name'        => 'WP Fusion',
				'icon_16'     => \Uncanny_Automator\Utilities::get_integration_icon( 'integration-wpfusion-icon-16.png' ),
				'icon_32'     => \Uncanny_Automator\Utilities::get_integration_icon( 'integration-wpfusion-icon-32.png' ),
				'icon_64'     => \Uncanny_Automator\Utilities::get_integration_icon( 'integration-wpfusion-icon-64.png' ),
				'logo'        => \Uncanny_Automator\Utilities::get_integration_icon( 'integration-wpfusion.png' ),
				'logo_retina' => \Uncanny_Automator\Utilities::get_integration_icon( 'integration-wpfusion@2x.png' ),
			)
		);
	}
}

...
class LD_CORRECT_ANSWER {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'LD_CORRECT_ANSWER' );
		...
		/* Translators: Trigger sentence */
			sprintf( esc_html__( 'A user answers {{a quiz:%1$s}} question correctly {{a number of:%2$s}} time(s)', 'uncanny-automator-pro' ), $this->get_trigger_meta(), 'NUMTIMES' )
		);
		// Non-active state sentence to show
		$this->set_readable_sentence( esc_attr__( 'A user answers {{a quiz}} question correctly', 'uncanny-automator-pro' ) );

...
/**
 * Class BP_USER_REMOVED_FROM_GROUPTYPE
 *
...
class BP_USER_REMOVED_FROM_GROUPTYPE {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'BP_USER_REMOVED_FROM_GROUPTYPES' );
		...
		$this->set_readable_sentence( esc_html__( 'A user is removed from a {{specific type of}} group', 'uncanny-automator-pro' ) );

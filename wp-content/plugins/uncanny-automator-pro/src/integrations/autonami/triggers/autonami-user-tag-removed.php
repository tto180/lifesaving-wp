...
/**
 * Class AUTONAMI_USER_TAG_REMOVED
 *
...
class AUTONAMI_USER_TAG_REMOVED {
	...
	public function setup_trigger() {
		...
		$this->set_trigger_code( 'USER_TAG_REMOVED' );
		...
		$this->set_sentence( sprintf( '{{A tag:%1$s}} is removed from a user', $this->get_trigger_meta() ) );

		$this->set_readable_sentence( '{{A tag}} is removed from a user' );

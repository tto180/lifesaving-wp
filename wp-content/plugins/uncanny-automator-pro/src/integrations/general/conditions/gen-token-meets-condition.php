...
/**
 * Class GEN_TOKEN_MEETS_CONDITION
 *
 * @package Uncanny_Automator_Pro
 */
class GEN_TOKEN_MEETS_CONDITION extends Action_Condition {
	...
	public function fields() {
		...
		return array(
			...
			$this->field->text(
				array(
					'option_code'            => 'TOKEN',
					'label'                  => esc_html__( 'Token', 'uncanny-automator-pro' ),
					'show_label_in_sentence' => false,

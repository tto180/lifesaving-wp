...
/**
 * Class ANON_CHARITABLE_RECURRING_CAMPAIGN_DONATION_CANCELLED
 *
 * @package Uncanny_Automator_Pro
 */
class ANON_CHARITABLE_RECURRING_CAMPAIGN_DONATION_CANCELLED extends \Uncanny_Automator\Recipe\Trigger {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'DONOR_CANCELS_RECURRING_DONATION';
	...
	protected function setup_trigger() {
		...
		$this->add_action( 'charitable_recurring_donation_status_charitable-cancelled', 999, 2 );
		...
		$this->set_sentence(
			sprintf(
				...
				esc_attr_x(
					'A recurring donation to {{a campaign:%1$s}} is cancelled',
					'Charitable',
					'uncanny-automator-pro'
				),
				self::TRIGGER_META

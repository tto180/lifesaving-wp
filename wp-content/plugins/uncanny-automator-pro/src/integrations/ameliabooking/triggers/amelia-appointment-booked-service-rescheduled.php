...
/**
 * Class AMELIA_APPOINTMENT_BOOKED_SERVICE_RESCHEDULED
 *
...
class AMELIA_APPOINTMENT_BOOKED_SERVICE_RESCHEDULED {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_RESCHEDULED';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_RESCHEDULED_META';
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Trigger sentence */
				esc_html__( 'A booking of an appointment for {{a specific service:%1$s}} is rescheduled', 'uncanny-automator' ),
		...
		/* Translators: Trigger sentence */
			esc_html__( 'A booking of an appointment for {{a specific service}} is rescheduled', 'uncanny-automator' )
		);

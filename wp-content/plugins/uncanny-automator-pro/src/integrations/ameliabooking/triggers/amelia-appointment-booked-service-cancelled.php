...
/**
 * Class AMELIA_APPOINTMENT_BOOKED_SERVICE_CANCELLED
 *
...
class AMELIA_APPOINTMENT_BOOKED_SERVICE_CANCELLED {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_CANCELLED';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'AMELIA_APPOINTMENT_BOOKED_SERVICE_CANCELLED_META';
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Trigger sentence */
				esc_html__( 'A booking of an appointment for {{a specific service:%1$s}} is canceled', 'uncanny-automator' ),
		...
		/* Translators: Trigger sentence */
			esc_html__( 'A booking of an appointment for {{a specific service}} is canceled', 'uncanny-automator' )
		);

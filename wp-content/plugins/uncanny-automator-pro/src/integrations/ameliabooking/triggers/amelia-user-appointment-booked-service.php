...
/**
 * Class AMELIA_USER_APPOINTMENT_BOOKED_SERVICE
 *
...
class AMELIA_USER_APPOINTMENT_BOOKED_SERVICE {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'AMELIA_USER_APPOINTMENT_BOOKED_SERVICE';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'AMELIA_USER_APPOINTMENT_BOOKED_SERVICE_META';
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Trigger sentence */
				esc_html__( 'A user books an appointment for {{a specific service:%1$s}}', 'uncanny-automator' ),
		...
		/* Translators: Trigger sentence */
			esc_html__( 'A user books an appointment {{for a specific service}}', 'uncanny-automator' )
		);

	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			sprintf(
				...
				esc_html__( 'A user starts {{a lesson:%1$s}} in {{a course:%2$s}}', 'uncanny-automator-pro' ),
		...
		$this->set_readable_sentence(
			/* Translators: Trigger sentence */
			esc_html__( 'A user starts {{a lesson}} in {{a course}}', 'uncanny-automator-pro' )
		);

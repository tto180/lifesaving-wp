	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			sprintf(
				...
				esc_html__( 'A user progresses in {{a course:%1$s}}', 'uncanny-automator-pro' ),
		...
		$this->set_readable_sentence(
			/* Translators: Trigger sentence */
			esc_html__( 'A user progresses in {{a course}}', 'uncanny-automator-pro' )
		);

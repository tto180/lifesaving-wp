...
/**
 * Class FLSUPPORT_TICKETCREATEDPRODUCTPERSON
 *
...
class FLSUPPORT_TICKETCREATEDPRODUCTPERSON {
	...
	public function __construct() {
		$this->trigger_code = 'FLSTTICKETCREATEDPRODUCTPERSON';
		$this->trigger_meta = 'FLSTTICKETCREATEDPRODUCTPERSON_META';
		$this->define_trigger();
	}
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( esc_attr__( 'A ticket for {{a product:%1$s}} is opened by {{a customer or an agent:%2$s}}', 'uncanny-automator-pro' ), $this->trigger_meta, 'flsupport_person_type' ),
			/* translators: Logged-in trigger - Fluent Support */
			'select_option_name'  => esc_attr__( 'A ticket for  {{a product}} is opened by {{a customer or an agent}}', 'uncanny-automator-pro' ),
			'action'              => 'fluent_support/ticket_created',
			'priority'            => 20,
			'accepted_args'       => 2,
			'validation_function' => array( $this, 'fsupport_ticket_product_opened_person' ),
	 ...
	 * @param $person
	 */
	public function fsupport_ticket_product_opened_person( $ticket, $person ) {

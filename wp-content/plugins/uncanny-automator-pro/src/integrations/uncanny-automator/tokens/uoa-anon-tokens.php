...
class UOA_Anon_Tokens extends Wp_Tokens {
	...
	public function __construct() {
		add_filter( 'automator_maybe_trigger_uoa_anonwpmagicbutton_tokens', array( $this, 'wp_possible_tokens' ), 20, 2 );
		add_filter( 'automator_maybe_trigger_uoa_anonwpmagiclink_tokens', array( $this, 'wp_possible_tokens' ), 20, 2 );

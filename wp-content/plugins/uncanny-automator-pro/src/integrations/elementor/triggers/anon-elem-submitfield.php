...
class ANON_ELEM_SUBMITFIELD {
	...
	public function __construct() {
		$this->trigger_code = 'ANONELEMSUBMITFIELD';
	...
	public function elem_submit_form( $record, $object ) {
		...
		$conditions = Automator()->helpers->recipe->elementor->pro->match_condition( $record, $form_id, $recipes, $this->trigger_meta, $this->trigger_code, 'SUBVALUE' );

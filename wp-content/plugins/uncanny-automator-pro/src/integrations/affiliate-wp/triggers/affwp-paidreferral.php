...
class AFFWP_PAIDREFERRAL {
	...
	public function __construct() {
		$this->trigger_code = 'PAIDREFERRAL';
		$this->trigger_meta = 'AFFWPPAIDREFERRAL';
		add_action(
			'plugins_loaded',
			function () {
				$this->define_trigger();
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( __( "An affiliate's referral of {{a specific type:%1\$s}} is paid", 'uncanny-automator-pro' ), $this->trigger_meta ),
			/* translators: Logged-in trigger - Affiliate WP */
			'select_option_name'  => __( "An affiliate's referral of {{a specific type}} is paid", 'uncanny-automator-pro' ),
			'action'              => 'affwp_set_referral_status',
			'priority'            => 99,
			'accepted_args'       => 3,
			'validation_function' => array( $this, 'affwp_paid_referral' ),
	 ...
	 * @return mixed
	 */
	public function affwp_paid_referral( $referral_id, $new_status, $old_status ) {

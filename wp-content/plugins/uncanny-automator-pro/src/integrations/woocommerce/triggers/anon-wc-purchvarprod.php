...
class ANON_WC_PURCHVARPROD {
	...
	public function __construct() {
		$this->trigger_code      = 'ANONWCPURCHASEVARIABLEPROD';
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => sprintf( __( 'A guest {{completes, pays for, lands on a thank you page for:%1$s}} an order with {{a product variation:%2$s}}', 'uncanny-automator-pro' ), $this->trigger_condition, $this->trigger_meta ),
			/* translators: Anonymous trigger - WooCommerce */
			'select_option_name'  => __( 'A guest {{completes, pays for, lands on a thank you page for}} an order with {{a product variation}}', 'uncanny-automator-pro' ),
			'action'              => array(

...
class BDB_INVITEACTIVATEUSER {
	...
	public function __construct() {
		$this->trigger_code = 'BDBINVITEACTIVATEUSER';
	...
	public function define_trigger() {
		...
		$trigger = array(
			...
			'sentence'            => esc_attr__( 'A user activates a new account via an email invitation', 'uncanny-automator-pro' ),
			/* translators: Logged-in trigger - BuddyBoss */
			'select_option_name'  => esc_attr__( 'A user activates a new account via an email invitation', 'uncanny-automator-pro' ),
			'action'              => 'bp_invites_member_invite_activate_user',
			'priority'            => 10,
			'accepted_args'       => 3,

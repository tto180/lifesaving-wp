...
/**
 * Class METABOX_USER_POST_FIELD_UPDATED
 *
...
class METABOX_USER_POST_FIELD_UPDATED {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'METABOX_USER_POST_FIELD_UPDATED';
	 ...
	 * @var string
	 */
	const TRIGGER_META = 'METABOX_USER_POST_FIELD_UPDATED_META';

	/**
	 * Prop:metabox.
	 *
	 * @property Metabox_Tokens_Pro $metabox.
	 */
	public $metabox;
	 ...
	 * Prop:metabox_tokens.
	 *
	 * @property Metabox_Tokens_Pro $metabox_tokens.
	 */
	...
	public function setup_trigger() {
		...
		$this->set_sentence(
			...
			/* Translators: Trigger sentence */
				esc_html__( 'A user updates {{a field:%1$s}} on {{a post:%2$s}}', 'uncanny-automator-pro' ),
		...
		/* Translators: Trigger sentence */
			esc_html__( 'A user updates {{a field}} on {{a post}}', 'uncanny-automator-pro' )
		);

...
/**
 * Class MAGIC_BUTTON_ANON_MAGIC_BUTTON_CLICKED
 *
			...
			foreach ( $results as $result ) {
				if ( true === $result['result'] ) {
					...
					if ( automator_filter_has_var( 'automator_button_post_title', INPUT_POST ) ) {
						...
						$save_meta['meta_value'] = Automator()->uap_sanitize( get_permalink( automator_filter_input( 'automator_button_post_id', INPUT_POST ) ) );
						Automator()->insert_trigger_meta( $save_meta );
					}

	...
	if ( ! function_exists( 'bridge_core_qode_slider' ) ) {
		function bridge_core_qode_slider( $atts, $content = null ) {
			...
			if ( $slider != "" ) {
				$args = array(
					'post_type'       => 'slides',
					'slides_category' => esc_attr( $slider ),
					'orderby'         => "menu_order",
					'order'           => "ASC",
					'posts_per_page'  => - 1
				);
				
				$slider_id   = get_term_by(
					'slug',
					esc_attr( $slider ),
					'slides_category'
				)->term_id;
				...
				if ( $height == "" || $height == "0" ) {
					...
					$slide_height = "height: " . esc_attr( $height ) . "px;";
					$data_height  = "data-height='" . esc_attr( $height ) . "'";
				}
				...
				if ( $slide_animation != "" ) {
					$slide_animation = 'data-slide_animation="' . esc_attr( $slide_animation ) . '"';
				} else {
					$slide_animation = 'data-slide_animation=""';
				}
				
				switch ( esc_attr( $animation_type ) ) {
					case 'fade':
				...
				if ( ( get_post_meta(
				     ...
				     && ( $bridge_qode_options['header_background_transparency_initial'] == "" || $bridge_qode_options['header_background_transparency_initial'] == "1" )
				     && ( $paspartu == false || $paspartu_on_top == false ) ) {
				...
				$html  .= '<div id="qode-' . $slider . '" ' . $anchor_data . ' ' . $responsive_coefficients_graphic_data . ' ' . $responsive_coefficients_title_data . ' ' . $responsive_coefficients_subtitle_data . ' ' . $responsive_coefficients_text_data . ' ' . $responsive_coefficients_button_data . ' class="carousel slide ' . esc_attr( $animation_type_class ) . ' ' . esc_attr( $full_screen_class ) . ' ' . esc_attr( $responsive_height_class ) . ' ' . esc_attr( $auto_start_class ) . ' ' . esc_attr( $header_effect_class ) . ' ' . esc_attr( $slider_thumbs_class ) . ' ' . esc_attr( $slider_transparency_class ) . ' ' . esc_attr( $custom_cursor ) . ' ' . esc_attr( $slider_advanced_responsiveness_class ) . '" ' . $slide_animation . ' ' . $data_height . ' ' . $data_parallax_effect . ' style="' . esc_attr( $slide_height ) . '"><div class="qode_slider_preloader"><div class="ajax_loader" ' . $loader_margin_top . '><div class="ajax_loader_1">' . bridge_qode_loading_spinners( true ) . '</div></div></div>';
				...
				if ( $query->have_posts() ) : $postCount = 0;
					while ( $query->have_posts() ) : $query->the_post();
						...
						$image_overlay_pattern       = get_post_meta(
							get_the_ID(),
						...
						$thumbnail_attributes        = bridge_qode_get_attachment_meta_from_url(
							$thumbnail,
							array( 'width', 'height' )
						);
						...
						$thumbnail_animation = get_post_meta(
							get_the_ID(),
						...
						$video_webm          = get_post_meta(
							get_the_ID(),
							"qode_slide-video-webm",
							true
						);
						$video_mp4           = get_post_meta(
							get_the_ID(),
							"qode_slide-video-mp4",
							true
						);
						$video_ogv           = get_post_meta(
							get_the_ID(),
							"qode_slide-video-ogv",
							true
						);
						$video_image         = get_post_meta(
							get_the_ID(),
							"qode_slide-video-image",
							true
						);
						$video_overlay       = get_post_meta(
							get_the_ID(),
							"qode_slide-video-overlay",
							true
						);
						$video_overlay_image = get_post_meta(
							get_the_ID(),
						...
						$content_animation = '';
						$content_animation .= get_post_meta(
							get_the_ID(),
						...
						if ( get_post_meta(
							     get_the_ID(),
							     "qode_slide-separator-after-title",
							     true
						     ) == 'yes' ) {
						...
						if ( get_post_meta(
							...
							$title_color .= "color: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-color",
									true
								) . ";";
						...
						if ( get_post_meta(
							...
							$title_font_size .= "font-size: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-font-size",
									true
								) . "px;";
							
							if ( (int) get_post_meta(
									get_the_ID(),
									"qode_slide-title-font-size",
									true
								) > 150 ) {
						...
						if ( get_post_meta(
							...
							$title_line_height .= "line-height: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-line-height",
									true
								) . "px;";
						...
						if ( ( get_post_meta(
							...
							$title_font_family .= "font-family: '" . str_replace(
									'+',
									' ',
									get_post_meta(
										get_the_ID(),
						...
						if ( get_post_meta(
							...
							$title_font_style .= "font-style: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-font-style",
									true
								) . ";";
						...
						if ( get_post_meta(
							...
							$title_font_weight .= "font-weight: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-font-weight",
									true
								) . ";";
						...
						if ( get_post_meta(
							...
							$title_letter_spacing .= "letter-spacing: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-letter-spacing",
									true
								) . "px;";
						...
						if ( get_post_meta(
							...
							$title_text_transform .= "text-transform: " . get_post_meta(
									get_the_ID(),
									"qode_slide-title-text-transform",
									true
								) . ";";
						...
						$slide_text_shadow         = get_post_meta(
							get_the_ID(),
							'qode_slide-hide-shadow',
							true
						);
						$slide_text_color          = get_post_meta(
							get_the_ID(),
							'qode_slide-text-color',
							true
						);
						$slide_text_font_size      = get_post_meta(
							get_the_ID(),
							'qode_slide-text-font-size',
							true
						);
						$slide_text_line_height    = get_post_meta(
							get_the_ID(),
							'qode_slide-text-line-height',
							true
						);
						$slide_text_font_family    = get_post_meta(
							get_the_ID(),
							'qode_slide-text-font-family',
							true
						);
						$slide_text_font_style     = get_post_meta(
							get_the_ID(),
							'qode_slide-text-font-style',
							true
						);
						$slide_text_font_weight    = get_post_meta(
							get_the_ID(),
							'qode_slide-text-font-weight',
							true
						);
						$slide_text_text_transform = get_post_meta(
							get_the_ID(),
							'qode_slide-text-text-transform',
							true
						);
						$slide_text_padding_top    = get_post_meta(
							get_the_ID(),
							'qode_slide_text_padding_top',
							true
						);
						$slide_text_padding_right  = get_post_meta(
							get_the_ID(),
							'qode_slide_text_padding_right',
							true
						);
						$slide_text_padding_bottom = get_post_meta(
							get_the_ID(),
							'qode_slide_text_padding_bottom',
							true
						);
						$slide_text_padding_left   = get_post_meta(
							get_the_ID(),
						...
						if ( $slide_text_color !== '' ) {
							...
							$button_style        = " style='border-color:" . get_post_meta(
									get_the_ID(),
									"qode_slide-text-color",
									true
								) . ";color:" . get_post_meta(
						...
						if ( ( $slide_text_font_family !== '-1' ) && ( $slide_text_font_family !== '' ) ) {
							$slide_text_styles[] = 'font-family: ' . str_replace(
									'+',
									' ',
						...
						if ( is_array( $slide_text_styles ) && count( $slide_text_styles ) ) {
							$slide_text_styles_string = 'style="' . implode(
									';',
									$slide_text_styles
								) . '"';
						}
						
						$graphic_alignment = get_post_meta(
							get_the_ID(),
							"qode_slide-graphic-alignment",
							true
						);
						$content_alignment = get_post_meta(
							get_the_ID(),
							"qode_slide-content-alignment",
							true
						);
						
						$separate_text_graphic = get_post_meta(
							get_the_ID(),
						...
						if ( get_post_meta(
							...
							$animate_image_class .= get_post_meta(
								get_the_ID(),
								"qode_enable_image_animation_type",
								true
							);
							$animate_image_data  .= "data-animate_image='" . get_post_meta(
									get_the_ID(),
									"qode_enable_image_animation_type",
									true
								) . "'";
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$vertical_content_width = "width:" . esc_attr(
										get_post_meta(
											get_the_ID(),
											"qode_slide_vertical_content_width",
											true
							...
							if ( get_post_meta(
								...
								$vertical_content_xaxis = "left:" . esc_attr(
										get_post_meta(
											get_the_ID(),
											"qode_slide_vertical_content_left",
											true
							...
							} else if ( get_post_meta(
								            get_the_ID(),
								            "qode_slide_vertical_content_right",
								            true
							            ) != "" ) {
								$vertical_content_xaxis = "right:" . esc_attr(
										get_post_meta(
											get_the_ID(),
											"qode_slide_vertical_content_right",
											true
							...
							if ( get_post_meta(
								...
								$content_width = "width:" . get_post_meta(
										get_the_ID(),
										"qode_slide-content-width",
										true
									) . "%;";
							...
							if ( get_post_meta(
								...
								$content_xaxis = "left:" . get_post_meta(
										get_the_ID(),
										"qode_slide-content-left",
										true
									) . "%;";
								...
								if ( get_post_meta(
									...
									$content_xaxis = "right:" . get_post_meta(
											get_the_ID(),
											"qode_slide-content-right",
											true
										) . "%;";
							...
							if ( get_post_meta(
								...
								$content_yaxis_start = "top:" . get_post_meta(
										get_the_ID(),
										"qode_slide-content-top",
										true
									) . "%;";
								$content_yaxis_end   = "top:" . ( get_post_meta(
									                                  get_the_ID(),
									                                  "qode_slide-content-top",
									                                  true
								                                  ) - 10 ) . "%;";
								...
								if ( get_post_meta(
									...
									$content_yaxis_start = "bottom:" . get_post_meta(
											get_the_ID(),
											"qode_slide-content-bottom",
											true
										) . "%;";
									$content_yaxis_end   = "bottom:" . ( get_post_meta(
										                                     get_the_ID(),
										                                     "qode_slide-content-bottom",
										                                     true
									                                     ) + 10 ) . "%;";
							...
							if ( get_post_meta(
								...
								$graphic_width = "width:" . get_post_meta(
										get_the_ID(),
										"qode_slide-graphic-width",
										true
									) . "%;";
							...
							if ( get_post_meta(
								...
								$graphic_xaxis = "left:" . get_post_meta(
										get_the_ID(),
										"qode_slide-graphic-left",
										true
									) . "%;";
								...
								if ( get_post_meta(
									...
									$graphic_xaxis = "right:" . get_post_meta(
											get_the_ID(),
											"qode_slide-graphic-right",
											true
										) . "%;";
							...
							if ( get_post_meta(
								...
								$graphic_yaxis_start = "top:" . get_post_meta(
										get_the_ID(),
										"qode_slide-graphic-top",
										true
									) . "%;";
								$graphic_yaxis_end   = "top:" . ( get_post_meta(
									                                  get_the_ID(),
									                                  "qode_slide-graphic-top",
									                                  true
								                                  ) - 10 ) . "%;";
								...
								if ( get_post_meta(
									...
									$graphic_yaxis_start = "bottom:" . get_post_meta(
											get_the_ID(),
											"qode_slide-graphic-bottom",
											true
										) . "%;";
									$graphic_yaxis_end   = "bottom:" . ( get_post_meta(
										                                     get_the_ID(),
										                                     "qode_slide-graphic-bottom",
										                                     true
									                                     ) + 10 ) . "%;";
						...
						if ( $qode_slide_general_animation_var === "yes" ) {
							...
							if ( get_post_meta(
								...
								$qode_slide_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_start",
										true
							...
							if ( get_post_meta(
								...
								$qode_slide_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$qode_slide_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_title_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_title_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_title_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_title_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_title_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_title_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_subtitle_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_subtitle_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_subtitle_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_subtitle_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_subtitle_data_end = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_subtitle_end",
										true
							...
							if ( get_post_meta(
								...
								$slide_subtitle_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_subtitle_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_graphics_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_graphics_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_graphics_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_graphics_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_graphics_data_end = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_graphics_end",
										true
							...
							if ( get_post_meta(
								...
								$slide_graphics_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_graphics_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_text_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_text_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_text_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_text_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_text_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_text_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_button_1_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_1_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_1_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_1_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_1_data_end = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_1_end",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_1_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_1_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_button_2_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_2_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_2_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_2_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_2_data_end = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_2_end",
										true
							...
							if ( get_post_meta(
								...
								$slide_button_2_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_button_2_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_separator_bottom_data_start = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_separator_bottom_start",
										true
							...
							if ( get_post_meta(
								...
								$slide_separator_bottom_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_separator_bottom_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_separator_bottom_data_end = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_separator_bottom_end",
										true
							...
							if ( get_post_meta(
								...
								$slide_separator_bottom_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_separator_bottom_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								...
								$slide_svg_data_start_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_svg_start_custom_style",
										true
							...
							if ( get_post_meta(
								...
								$slide_svg_data_end_custom_style = esc_attr(
									get_post_meta(
										get_the_ID(),
										"qode_slide_data_svg_end_custom_style",
										true
						...
						if ( get_post_meta(
							...
							$navigation_color = 'data-navigation-color="' . get_post_meta(
									get_the_ID(),
									"qode_slide-navigation-color",
									true
								) . '"';
						...
						if ( $slide_type == 'video' ) {
							...
							$html .= '<object width="320" height="240" type="application/x-shockwave-flash" data="' . get_template_directory_uri() . '/js/flashmediaelement.swf">
													...
													<img itemprop="image" src="' . $video_image . '" width="1920" height="800" title="' . esc_html__(
						...
						if ( get_post_meta(
							...
							$slide_subtitle_color           = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-color',
								true
							);
							$slide_subtitle_font_size       = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-font-size',
								true
							);
							$slide_subtitle_line_height     = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-line-height',
								true
							);
							$slide_subtitle_font_family     = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-font-family',
								true
							);
							$slide_subtitle_font_style      = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-font-style',
								true
							);
							$slide_subtitle_font_weight     = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-font-weight',
								true
							);
							$slide_subtitle_text_transform  = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-text-transform',
								true
							);
							$slide_subtitle_letter_spacing  = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-letter-spacing',
								true
							);
							$slide_subtitle_position        = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-position',
								true
							);
							$slide_subtitle_bg_color        = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-background-color',
								true
							);
							$slide_subtitle_bg_transparency = get_post_meta(
								get_the_ID(),
								'qode_slide-subtitle-bg-color-transparency',
								true
							);
							$slide_subtitle_margin_bottom   = get_post_meta(
								get_the_ID(),
								'qode_slide_subtitle_margin_bottom',
								true
							);
							$slide_subtitle_padding_top     = get_post_meta(
								get_the_ID(),
								'qode_slide_subtitle_padding_top',
								true
							);
							$slide_subtitle_padding_right   = get_post_meta(
								get_the_ID(),
								'qode_slide_subtitle_padding_right',
								true
							);
							$slide_subtitle_padding_bottom  = get_post_meta(
								get_the_ID(),
								'qode_slide_subtitle_padding_bottom',
								true
							);
							$slide_subtitle_padding_left    = get_post_meta(
								get_the_ID(),
							...
							if ( ( $slide_subtitle_font_family !== '-1' ) && ( $slide_subtitle_font_family !== '' ) ) {
								$slide_subtitle_styles[] = 'font-family: ' . str_replace(
										'+',
										' ',
										$slide_subtitle_font_family
									);
							}
							...
							if ( count( $slide_subtitle_styles ) ) {
								$slide_subtitle_styles_string = 'style="' . implode(
										';',
										$slide_subtitle_styles
									) . '"';
							}
							...
							if ( $slide_subtitle_bg_color ) {
								...
								$slide_subtitle_span_styles[] = 'background-color: ' . bridge_qode_rgba_color(
										$slide_subtitle_bg_color,
										$slide_subtitle_init_transparency
									);
							}
							...
							if ( is_array( $slide_subtitle_span_styles ) && count( $slide_subtitle_span_styles ) ) {
								$slide_subtitle_span_styles_string = 'style="' . implode(
										';',
										$slide_subtitle_span_styles
									) . '"';
							}
							
							if ( $slide_subtitle_position != "bellow_title" ) {
								$html_text .= '<div ' . $slide_subtitle_data . '>';
								$html_text .= '<h4 class="' . implode(
										' ',
										$slide_subtitle_classes
									) . '" ' . $slide_subtitle_styles_string . '><span ' . $slide_subtitle_span_styles_string . '>' . get_post_meta(
									              get_the_ID(),
									              'qode_slide-subtitle',
									              true
								              ) . '</span></h4>';
						...
						if ( get_post_meta(
							...
							if ( get_post_meta(
								     get_the_ID(),
								     "qode_slide-border-around-title",
								     true
							     ) == 'yes' ) {
								...
								$slide_title_border_color        = get_post_meta(
									get_the_ID(),
									'qode_slide-border-around-title-color',
									true
								);
								$slide_title_border_transparency = get_post_meta(
									get_the_ID(),
									'qode_slide-border-around-title-transparency',
									true
								);
								...
								if ( $slide_title_border_color !== '' ) {
									...
									if ( $slide_title_border_transparency !== '' ) {
										...
										$slide_title_border_styles[] = 'border-color: ' . bridge_qode_rgba_color(
												$slide_title_border_color,
												$slide_title_border_transparency
											);
									} else {
								...
								$slide_title_border_styles_string .= implode(
									                                     ';',
									                                     $slide_title_border_styles
								                                     ) . ';';
							}
							
							$slide_title_bg_color        = get_post_meta(
								get_the_ID(),
								"qode_slide-title-background-color",
								true
							);
							$slide_title_bg_transparency = get_post_meta(
								get_the_ID(),
							...
							if ( $slide_title_bg_color ) {
								...
								$slide_title_background_styles[] = 'background-color: ' . bridge_qode_rgba_color(
										$slide_title_bg_color,
										$slide_title_init_transparency
									);
							}
							
							if ( is_array( $slide_title_background_styles ) && count( $slide_title_background_styles ) ) {
								$slide_title_background_styles_string = implode(
									';',
									$slide_title_background_styles
								);
							}
						...
						if ( get_post_meta(
						     ...
						     && $slide_subtitle_position == "bellow_title" ) {
							$html_text .= '<div ' . $slide_subtitle_data . '>';
							$html_text .= '<h4 class="q_slide_subtitle" ' . $slide_subtitle_styles_string . '><span ' . $slide_subtitle_span_styles_string . '>' . get_post_meta(
									get_the_ID(),
									'qode_slide-subtitle',
									true
								) . '</span></h4>';
						...
						if ( get_post_meta(
							...
							$slide_separator_color          = get_post_meta(
								get_the_ID(),
								"qode_slide-separator-color",
								true
							);
							$slide_separator_transparency   = get_post_meta(
								get_the_ID(),
								"qode_slide-separator-transparency",
								true
							);
							$slide_separator_width          = get_post_meta(
								get_the_ID(),
								"qode_slide-separator-width",
								true
							);
							$slide_separator_gradient       = get_post_meta(
								get_the_ID(),
								"qode_slide_separator_gradient",
								true
							);
							...
							if ( $slide_separator_color !== '' ) {
								...
								if ( $slide_separator_transparency !== '' ) {
									...
									$slide_separator_rgba_color = bridge_qode_rgba_color(
						...
						$html_text .= '<p class="q_slide_text" ' . $slide_text_styles_string . ' ' . $slide_text_data . '><span>' . get_post_meta(
								get_the_ID(),
								"qode_slide-text",
								true
							) . '</span></p>';
						...
						if ( get_post_meta(
							     get_the_ID(),
							     "qode_slide-button-hover-type",
							     true
						     ) != "" ) {
							$button_hover_type1 = get_post_meta(
								get_the_ID(),
								"qode_slide-button-hover-type",
								true
							);
						...
						if ( get_post_meta(
							...
							$first_btn_icon_pack    = get_post_meta(
								get_the_ID(),
							...
							if ( $first_btn_icon_pack !== 'no_icon' || $first_btn_icon_pack != '' ) {
								...
								if ( is_object( $first_btn_icon_collection )
								     && method_exists(
									     $first_btn_icon_collection,
									     'render'
								     )
								     && get_post_meta(
									        get_the_ID(),
									        'qode_slide_button1_icon_' . $first_btn_icon_collection->param,
									        true
								        ) !== '' ) {
							...
							if ( get_post_meta(
								     get_the_ID(),
								     "qode_slide_button_type",
								     true
							     ) == 'qode-button-v2' ) {
								
								$button_v2_hover      = get_post_meta(
									get_the_ID(),
									"qode_slide_button_v2_hover_type",
									true
								);
								$button_icon_gradient = get_post_meta(
									get_the_ID(),
									"qode_slide_button_v2_icon_gradient",
									true
								);
								...
								if ( $first_btn_icon_pack != '' || $first_btn_icon_pack != 'no_icon' ) {
									...
									$button_icon_params[ bridge_qode_icon_collections()->getIconCollectionParamNameByKey( $first_btn_icon_pack ) ] = get_post_meta(
										get_the_ID(),
										'qode_slide_button1_icon_' . bridge_qode_icon_collections()->getIconCollectionParamNameByKey( $first_btn_icon_pack ),
										true
									);
								}
								...
								$html_text .= '<a itemprop="url" class="qbutton green ' . esc_attr( $button_hover_type1 ) . '" href="' . get_post_meta(
										get_the_ID(),
										"qode_slide-button-link",
										true
									) . '" ' . $slide_button_1_data . '>' . get_post_meta(
									              get_the_ID(),
									              "qode_slide-button-label",
									              true
								              ) . $first_button_icon_html . '</a>';
							}
						}
						...
						if ( get_post_meta(
							     get_the_ID(),
							     "qode_slide-button-hover-type2",
							     true
						     ) != "" ) {
							$button_hover_type2 = get_post_meta(
								get_the_ID(),
								"qode_slide-button-hover-type2",
								true
							);
						...
						if ( get_post_meta(
							...
							$second_btn_icon_pack    = get_post_meta(
								get_the_ID(),
							...
							if ( $second_btn_icon_pack !== 'no_icon' || $second_btn_icon_pack != '' ) {
								...
								if ( is_object( $second_btn_icon_collection )
								     && method_exists(
									     $second_btn_icon_collection,
									     'render'
								     )
								     && get_post_meta(
									        get_the_ID(),
									        'qode_slide_button2_icon_' . $second_btn_icon_collection->param,
									        true
								        ) !== '' ) {
							...
							if ( get_post_meta(
								     get_the_ID(),
								     "qode_slide_button_type2",
								     true
							     ) == 'qode-button-v2' ) {
								
								//$button2_v2_hover = get_post_meta(get_the_ID(), "qode_slide_button_v2_hover_type2", true);
								$button2_icon_gradient = get_post_meta(
									get_the_ID(),
									"qode_slide_button2_v2_icon_gradient",
									true
								);
								...
								if ( $second_btn_icon_pack != '' || $second_btn_icon_pack != 'no_icon' ) {
									...
									$button2_icon_params[ bridge_qode_icon_collections()->getIconCollectionParamNameByKey( $second_btn_icon_pack ) ] = get_post_meta(
										get_the_ID(),
										'qode_slide_button2_icon_' . bridge_qode_icon_collections()->getIconCollectionParamNameByKey( $second_btn_icon_pack ),
										true
									);
								}
								...
								$html_text .= '<a itemprop="url" class="qbutton white ' . esc_attr( $button_hover_type2 ) . '"' . $button_style . ' href="' . get_post_meta(
										get_the_ID(),
										"qode_slide-button-link2",
										true
									) . '"  ' . $slide_button_2_data . '>' . get_post_meta(
									              get_the_ID(),
									              "qode_slide-button-label2",
									              true
								              ) . $second_button_icon_html . '</a>';
							}
						}
						...
						if ( get_post_meta(
							...
							if ( $slide_anchor_style !== '' ) {
								$slide_anchor_style = 'style="' . implode(
										';',
										$slide_anchor_style
									) . '"';
							}
							
							$html_text .= '<div class="slide_anchor_holder"><a ' . $slide_anchor_style . ' class="slide_anchor_button anchor" href="' . get_post_meta(
									get_the_ID(),
									"qode_slide-anchor-button",
									true

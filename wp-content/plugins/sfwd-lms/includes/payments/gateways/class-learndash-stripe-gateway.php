...
use LearnDash\Core\Modules\Payments\Gateways\Stripe\Webhook_Setup_Validator;
		...
		private function validate_webhook_event_or_fail(): Stripe\Event {
			...
			if ( self::EVENT_COUPON_DELETED === $event->type ) {
				try {
					 ...
					 *
					 * @var Webhook_Setup_Validator $webhook_setup_validator Webhook setup validator.
					 */
					$webhook_setup_validator = App::get( Webhook_Setup_Validator::class );

		...
		<div class="gv-layout__columns">
			<div class="gv-card" id="api_settings_column">
				...
				<div class="gv-card__body">
					<div class="gv-card__body-inner" id="api_form_inner">
						<?php if (! $is_license_activated) : ?>
					...
					<?php else: ?>
							<div class="gv-fields__container">
								<div class="gv-fields__item">
									...
									<div class="gv-fields__field gv-input__field gv-input__pwd">
										<h3 style="letter-spacing: 2px; margin-top: 0.25em;"><?php esc_html_e(gv_mask_str($gv_license_key) ); ?></h3>
									</div>
								</div>
								<div class="gv-fields__item">
									<div
										class="gv-fields__label"><span><?php esc_html_e( 'Product ID', 'gplvault' ); ?></span>
									</div>
									<div class="gv-fields__field gv-input__field">
										<h3 style="margin-top: 0.25em;"><?php esc_html_e($gv_product_id); ?></h3>
									</div>
								</div>
							</div>
					<?php endif; ?>

...
class GPLVault_Admin {
	...
	private function init_hooks() {
		...
		add_action( 'admin_init', array( $this, 'manage_log_remove' ) );
		add_action( 'admin_init', array( $this, 'manage_log_download' ) );
...
//			wp_enqueue_script( 'gv-common' );
  ...
  <path fill="currentColor" class="cls-1" d="M27.77 49.46l2.73-1.39a17 17 0 0027.5.32l1.88 1L62.29 45l-1.87-1A17 17 0 0047 21.34V19h-5v15.16a5.78 5.78 0 00-2.28 3.63L25.53 45zM35 45.77l7-3.53a4.63 4.63 0 004.81.07L53.58 46A12 12 0 0135 45.77zm21-4.18l-6.87-3.69A4.31 4.31 0 0047 34.18V26.4c5.77 1.33 11.18 7.71 9 15.19z"/>
	...
	public function admin_menu_lifetime_link(): void
	{
		...
		if ( isset( $submenu[ static::SLUG_SETTINGS ] ) ) {
			$submenu[ static::SLUG_SETTINGS ][] = array(__( '<span id="gv_promo_link" class="gv-promo-link">Go Lifetime</span>', 'gplvault' ), $capability, self::LIFETIME_URL); // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
		}
	}

...
class AdminGroupEmailFields {
	...
	public function render_invite_metabox( $post ) {
		...
		$send_enrollment_email_override = get_post_meta( $post->ID, 'ulgm_override_send_enrollment_email', true );
		if ( empty( $send_enrollment_email_override ) ) {
			$send_enrollment_email_override = 'no';
		}

		$send_enrollment_email_subject = get_post_meta( $post->ID, 'ulgm_override_send_enrollment_email_subject', true );
		if ( empty( $send_enrollment_email_subject ) ) {
			$send_enrollment_email_subject = AdminPage::$ulgm_management_admin_page['ulgm_invitation_user_email_subject'];
		}
		$send_enrollment_email_body = get_post_meta( $post->ID, 'ulgm_override_send_enrollment_email_body', true );
		if ( empty( $send_enrollment_email_body ) ) {
			$send_enrollment_email_body = AdminPage::$ulgm_management_admin_page['ulgm_invitation_user_email_body'];
		}
										...
										<div class="uo-admin-accordion-item__content">
											<div class="uo-admin-form">
												...
												<div class="uo-admin-field">
													<label class="uo-checkbox">
														<input type="checkbox"
															   name="ulgm_override_send_enrollment_email"
															   id="ulgm_override_send_enrollment_email"
															   value="yes"
																<?php
																if ( 'yes' === $send_enrollment_email_override ) {
																	echo 'checked="checked"';
																}
																?>
														/>
														<div class="uo-checkmark"></div>
														<span class="uo-label">
													<?php echo __( 'Override "Send enrollment key" Email.', 'uncanny-learndash-groups' ); ?>
												</span>
													</label>
												</div>
												...
												<div class="uo-admin-field">
													...
													<input class="uo-admin-input" type="text"
														   name="ulgm_override_send_enrollment_email_subject"
														   id="ulgm_override_send_enrollment_email_subject"
														   value="<?php echo $send_enrollment_email_subject; ?>"/>
												</div>
												...
												<div class="uo-admin-field">
													...
													<div class="uo-admin-wp-editor">
														<?php wp_editor( $send_enrollment_email_body, 'ulgm_override_send_enrollment_email_body' ); ?>
													</div>
												</div>
											</div>
										</div>
	...
	public function save_email_body_changes( $post_id, $post ) {
		...
		$send_enrollment_email_override = isset( $_POST['ulgm_override_send_enrollment_email'] ) ? sanitize_text_field( wp_unslash( $_POST['ulgm_override_send_enrollment_email'] ) ) : 'no';
		$send_enrollment_email_subject  = isset( $_POST['ulgm_override_send_enrollment_email_subject'] ) ? sanitize_text_field( wp_unslash( $_POST['ulgm_override_send_enrollment_email_subject'] ) ) : '';
		$send_enrollment_email_body     = isset( $_POST['ulgm_override_send_enrollment_email_body'] ) ? wp_unslash( $_POST['ulgm_override_send_enrollment_email_body'] ) : ''; //phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized

		update_post_meta( $post_id, 'ulgm_override_send_enrollment_email', $send_enrollment_email_override );
		update_post_meta( $post_id, 'ulgm_override_send_enrollment_email_subject', $send_enrollment_email_subject );
		update_post_meta( $post_id, 'ulgm_override_send_enrollment_email_body', $send_enrollment_email_body );
	}
}

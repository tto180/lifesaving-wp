...
class GravityFormsSupport {
	...
	public function create_submenu() {
		...
		add_submenu_page(
			$parent_slug,
			__( 'Gravity Forms', 'uncanny-learndash-groups' ),
			__( 'Gravity Forms', 'uncanny-learndash-groups' ),
			$capability,
			'uncanny-groups-gravity-forms',
			array(
				$this,
					...
					<div class="ulgm-admin-content">
						...
						<div class="uo-admin-section">
							<div class="uo-admin-header">
								<div
									class="uo-admin-title"><?php _e( 'Gravity Forms registration form', 'uncanny-learndash-groups' ); ?></div>
							</div>
								...
								<form method="post" action="" id="uncanny-learndash-groups-form">
									...
									<div class="uo-admin-form">
										...
										<div class="uo-admin-field">
											<div
												class="uo-admin-label"><?php _e( 'Select form', 'uncanny-learndash-groups' ); ?></div>

											<select class="uo-admin-select" name="registration_form"
													id="registration_form">
												<option
													value="0"><?php _e( 'Forms', 'uncanny-learndash-groups' ); ?></option>
										...
										<div class="uo-admin-field">
											<label class="uo-checkbox">
												<input type="checkbox" value="1" name="registration-field-mandatory"
													   id="registration-field-mandatory"
													   <?php
														if ( 1 === intval( $gravity_form_field_mandatory ) ) {
										...
										<div class="uo-admin-field">
											<div
												class="uo-admin-label"><?php _e( 'User registration field label:', 'uncanny-learndash-groups' ); ?></div>

											<input class="uo-admin-input" type="text"
												   value="
												   <?php
													if ( null !== $gravity_form_field_label ) {
										...
										<div class="uo-admin-field">
											<div
												class="uo-admin-label"><?php _e( 'User registration field error message:', 'uncanny-learndash-groups' ); ?></div>

											<input class="uo-admin-input" type="text"
												   value="
												   <?php
													if ( null !== $gravity_form_field_error_message ) {
										...
										<div class="uo-admin-field">
											<div
												class="uo-admin-label"><?php _e( 'User registration field placeholder:', 'uncanny-learndash-groups' ); ?></div>

											<input class="uo-admin-input" type="text"
												   value="
												   <?php
													if ( null !== $gravity_form_field_placeholder ) {
	...
	public function gf_user_register( $user_id ) {
		if ( is_array( self::$code_details ) && 'success' === self::$code_details['result'] ) {
			...
			$result      = ulgm()->group_management->set_user_to_code( $user_id, $code_registration, SharedFunctions::$not_started_status, $ld_group_id );
			if ( $result ) {

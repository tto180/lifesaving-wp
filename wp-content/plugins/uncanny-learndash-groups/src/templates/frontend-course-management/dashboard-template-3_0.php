																		...
																		<?php if ( $topic->has_quizzes ) { ?>
																			...
																			<div class="ulg-manage-progress-topic__quizzes">
																				...
																				<div class="ulg-manage-progress-quizzes <?php echo implode( ' ', $quizzes_css_classes ); ?>">
																					<?php
																					/* <div class="ulg-manage-progress-quizzes__header">
																									...
																									<div class="ulg-manage-progress-quiz__details">
																										<div class="ulg-manage-progress-quiz__left">
																											<div class="ulg-manage-progress-quiz__progress-actions">
																												<div class="ulg-manage-progress-quiz__confirmation_wrap-default">
																													<div class="ulg-manage-progress-quiz__progress-action-checkbox" data-action="quiz-maybe-confirm">
																												...
																												<div class="ulg-manage-progress-quiz__confirmation_wrap-quiz-reset">
																													<div class="ulg-manage-progress-quiz__progress-action-checkbox" data-action="quiz-reset-yes">
																														<span class="ulg-manage-progress-quiz__progress-action-confirm-text">
																															<?php _e( 'Yes', 'uncanny-learndash-groups' ); ?>
																														</span>
																													</div>
																													<div class="ulg-manage-progress-quiz__progress-action-checkbox" data-action="quiz-reset-no">
																														<span class="ulg-manage-progress-quiz__progress-action-confirm-text">
																															<?php _e( 'No', 'uncanny-learndash-groups' ); ?>
																														</span>
																													</div>
																													<div class="ulg-manage-progress-quiz__confirmation-text">
																														<?php _e( 'Also remove quiz records?', 'uncanny-learndash-groups' ); ?>
																													</div>
																												</div>
																											</div>

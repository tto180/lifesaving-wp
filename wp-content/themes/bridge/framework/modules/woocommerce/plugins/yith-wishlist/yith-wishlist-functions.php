...
if( ! function_exists( 'bridge_qode_wishlist_page_responsive' ) ) {
	function bridge_qode_wishlist_page_responsive() {
		return false;
	}
	
	add_filter( 'yith_wcwl_is_wishlist_responsive', 'bridge_qode_wishlist_page_responsive' );
}